...
- Miracast Wi-Fi Direct / WFD advertisement groundwork
- Google Cast receiver stub / fallback handling pending Cast registration
...
- **Miracast is discovery/advertising groundwork, not full WFD streaming yet.** Full WFD RTSP negotiation, MPEG-TS demuxing, HDCP negotiation, and audio/video decode integration remain future work.
